# data_works_cloud
[![Docker Image CI](https://github.com/lelkaklel/data_works_cloud/actions/workflows/docker-image.yml/badge.svg)](https://github.com/lelkaklel/data_works_cloud/actions/workflows/docker-image.yml)
...
* Based on neylsoncrepalde/docker-airflow and puckel/docker-airflow github.com repos
...
Up to this moment, there is no public image `puckel/docker-airflow:2.0.0`, so we have to build it. After cloning this repo, you may do
    ...
    docker build -t lelkaklel/docker-airflow:2.0.0 .
...
Optionally install [Extra Airflow Packages](https://airflow.incubator.apache.org/installation.html#extra-package) and/or python dependencies at build time :
    ...
    docker build --rm --build-arg AIRFLOW_DEPS="datadog,dask" -t lelkaklel/docker-airflow:2.0.0 .
    docker build --rm --build-arg PYTHON_DEPS="flask_oauthlib>=0.9" -t lelkaklel/docker-airflow:2.0.0 .

or combined

    docker build --rm --build-arg AIRFLOW_DEPS="datadog,dask" --build-arg PYTHON_DEPS="flask_oauthlib>=0.9" -t lelkaklel/docker-airflow:2.0.0 .

Don't forget to update the airflow images in the docker-compose files to lelkaklel/docker-airflow:latest.

## Usage

By default, docker-airflow runs Airflow with **SequentialExecutor** :

    docker run -d -p 8080:8080 lelkaklel/docker-airflow:2.0.0 webserver
